...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-03-22 16:12:04',NULL),('diagnostics.include_raw','OFF','2021-03-22 16:12:04',NULL),('ps_thread_trx_info.max_length','65535','2021-03-22 16:12:04',NULL),('statement_performance_analyzer.limit','100','2021-03-22 16:12:04',NULL),('statement_performance_analyzer.view',NULL,'2021-03-22 16:12:04',NULL),('statement_truncate_len','64','2021-03-22 16:12:04',NULL);
...
--
-- Current Database: `studentproject`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `studentproject` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `university` (
  ...
  `quantity_users` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `university` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
...
INSERT INTO `user` VALUES (49,'m99alissa@gmail.com','Ikbal','12345','Middlesex','Syria'),(50,'jack@gmail.com','Jack','123','Oxford','England'),(51,'tony@gmail.com','tony','123','kingston','italy'),(52,'badawy@gmail.com','badawy','123','middlesex','Egypt ');
...
-- Dump completed on 2021-04-26 16:55:21
